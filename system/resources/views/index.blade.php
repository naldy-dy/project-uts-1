            ...
            <div class="owl-testimonial owl-carousel owl-theme mb-md-0 mb-sm-5 mb-4">
                ...
                <div class="item">
                    <div class="row slider-info">
                        ...
                        <div class="col-lg-4 col-md-8 img-circle mt-lg-0 mt-4">
                            <img src="{{url('public')}}/assets/images/fashion.jpg" class="img-fluid radius-image-full" alt="client image">
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="row slider-info">
                        ...
                        <div class="col-lg-4 col-md-8 img-circle mt-lg-0 mt-4">
                            <img src="{{url('public')}}/assets/images/food.jpg" class="img-fluid radius-image-full" alt="client image">
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="row slider-info">
                        ...
                        <div class="col-lg-4 col-md-8 img-circle mt-lg-0 mt-4">
                            <img src="{{url('public')}}/assets/images/lifestyle.jpg" class="img-fluid radius-image-full"
                                alt="client image">
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
                            ...
                            <div class="card-header p-0 position-relative">
                                <a href="#blog-single.html">
                                    <img class="card-img-bottom d-block radius-image-full"
                                        src="{{url('public')}}/assets/images/image1.jpg" alt="Card image cap">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 mt-md-0 mt-sm-5 mt-4">
                        <div class="card">
                            <div class="card-header p-0 position-relative">
                                <a href="#blog-single.html">
                                    <img class="card-img-bottom d-block radius-image-full"
                                        src="{{url('public')}}/assets/images/image2.jpg" alt="Card image cap">
                                </a>
                            </div>
                            <div class="card-body blog-details">
            ...
            <div class="col-lg-4 trending mt-lg-0 mt-5">
                ...
                <div class="sponsers mt-5">
                    ...
                    <a href="#ad-banner"><img src="{{url('public')}}/assets/images/ad.jpg" alt="" class="img-fluid radius-image-full" /></a>
                ...
                <div class="bg-clr-white hover-box">
                    <div class="row">
                        <div class="col-sm-6 position-relative">
                            <a href="#blog-single.html">
                                <img class="card-img-bottom d-block radius-image-full" src="{{url('public')}}/assets/images/trending1.jpg"
                                    alt="Card image cap">
                            </a>
                        </div>
            ...
            <div class="col-lg-6 mt-lg-0 mt-4">
                <div class="bg-clr-white hover-box">
                    <div class="row">
                        <div class="col-sm-6 position-relative">
                            <a href="#blog-single.html">
                                <img class="card-img-bottom d-block radius-image-full" src="{{url('public')}}/assets/images/trending2.jpg"
                                    alt="Card image cap">
                            </a>
                        </div>
                        <div class="col-sm-6 card-body blog-details align-self">
